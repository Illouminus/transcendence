...
<div class="w-full max-w-sm bg-white/5 backdrop-blur-md border border-gray-200/10 rounded-xl shadow-lg dark:bg-gray-800/50 dark:border-gray-700/50 hover:bg-gray-800/70 transition-all duration-300" data-friend-id="${friend.id}">
    <div class="flex flex-col items-center justify-center p-4">
        ...
        <div class="flex mt-6 space-x-2">
            ...
            <div class="group/tooltip relative">
                <button class="${friend.isBlocked ? 'unblock' : 'block'}-button inline-flex items-center p-2 text-sm font-medium text-center text-white bg-gray-800/70 border border-gray-600/30 rounded-lg hover:bg-yellow-500/30 hover:border-yellow-500/50 focus:ring-2 focus:outline-none focus:ring-yellow-500/50 transition-all duration-200 backdrop-blur-sm group">
                    <svg class="w-5 h-5 group-hover:text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ${friend.isBlocked ? `
